...
namespace CVideoAPI.Migrations
{
    ...
    [Migration("20200704074114_cvideo4.1")]
    partial class cvideo41
    {
            ...
            modelBuilder.Entity("CVideoAPI.Models.CV", b =>
                {
                    ...
                    b.Property<Guid?>("AccessKeyKey")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("AccessKeyUserId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccessKeyKey", "AccessKeyUserId");
            ...
            modelBuilder.Entity("CVideoAPI.Models.CV", b =>
                {
                    ...
                    b.HasOne("CVideoAPI.Models.AccessKey", "AccessKey")
                        .WithMany()
                        .HasForeignKey("AccessKeyKey", "AccessKeyUserId");
                });
